...
export function Footer() {
  return (
    <footer className="py-8 border-t transition-colors duration-300 border-gray-100 bg-background/50 dark:border-white/5">
      <div className="flex items-center justify-between px-4 md:px-8 mx-auto max-w-[1500px] flex-col md:flex-row gap-6">
        ...
        <div className="flex gap-4">
          <Link href="#" className="text-gray-400 hover:text-[#1DA1F2] dark:hover:text-[#1DA1F2] transition-colors">
          ...
          <Link href="#" className="text-gray-400 hover:text-[#EA4335] dark:hover:text-[#EA4335] transition-colors">
