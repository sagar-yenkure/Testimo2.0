...
export function UserNavbar() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 pointer-events-none ${scrolled ? "py-3" : "py-5"
        }`}
    >
      <div className="flex items-center justify-between px-4 md:px-8 mx-auto max-w-[1400px] pointer-events-auto">
