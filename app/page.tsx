  ...
  return (
    <div className="min-h-screen overflow-hidden relative font-sans bg-[#f8faff] text-gray-900 dark:bg-[#050505] dark:text-white transition-colors duration-300">
        ...
        <div className="flex items-center justify-between px-8 mx-auto max-w-7xl pointer-events-auto">
          ...
          <div className="hidden md:flex items-center gap-1 text-[14px] font-medium px-2 py-1.5 rounded-full shadow-sm backdrop-blur-md border bg-white/60 border-gray-200/50 text-gray-600 dark:bg-white/10 dark:border-white/10 dark:text-gray-300 transition-colors">
            ...
            {['Features', 'How it works', 'Resources', 'Pricing'].map(item => (
              <Link key={item} href="#" className="px-4 py-2 rounded-full hover:bg-gray-100/80 hover:text-gray-900 dark:hover:bg-white/10 dark:hover:text-white transition-colors"
              >{item}</Link>
            ))}
          </div>
      ...
      <div className="pt-44">
        ...
        <section className="py-24 relative z-10 w-full px-4 transition-colors bg-white dark:bg-[#050505]">
        ...
        {/* Footer */}
        <footer className="py-12 border-t transition-colors border-gray-100 text-gray-500 bg-white/50 dark:border-white/5 dark:text-gray-400 dark:bg-black/40">
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-8">
              ...
              <div className="flex flex-wrap justify-center gap-8 text-sm">
                <Link href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Product</Link>
                <Link href="#" className="hover:text-gray-900 dark:hover:text-white transition-colors">Features</Link>
